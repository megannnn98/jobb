...
KAGGLE_DATASET = os.environ.get("KAGGLE_DATASET", "rubert-job-reviews-sentiment")

MODEL_NAME = "ai-forever/ruRoberta-large"

if IS_KAGGLE:
    OUTPUT_DIR = Path("/kaggle/working/ruroberta-sentiment")
    ...
    OUTPUT_DIR = Path("outputs/ruroberta-sentiment")
